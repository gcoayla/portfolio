  ...
  const classes = clsx(
    {
      ...
      "text-4xl md:text-6xl font-bold leading-tight": variant === "h1",
      "text-3xl font-bold leading-tight": variant === "h2",
      "text-2xl font-bold leading-tight": variant === "h3",
      "text-xl md:text-2xl font-bold leading-tight": variant === "h4",
