  ...
  const classes = clsx(
    {
      ...
      "text-5xl md:text-6xl font-bold leading-tight": variant === "h1",
      "text-2xl font-bold leading-tight": variant === "h2",
      "text-3xl font-bold leading-tight": variant === "h3",
      "text-2xl md:text-2xl font-bold leading-tight": variant === "h4",
